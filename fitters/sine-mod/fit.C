...
// *** *** ROOT-POWERED LEAST SQUARES USER-DEFINED FITTER *** *** //
// 		   USING: Root (framework), Minuit (fitter LSQ), Migrad (minimizer)
...
*/// SINUSOIDAL
					fitval = p[0] + p[1]*sin(p[2] + p[3]*x[0]);	// PARAM: 4
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   TF1* f1 = new TF1("f1", fitfunc, -5, 50, 4);	// LAST NUMBER --> Number of parameters to fit

   // INITIAL GUESSES AND PARAMETER NAMES ################################################################
   f1->SetParameters(0.1, 1.0, 0.1, 1.0);
   f1->SetParNames("y off", "ampl", "phase", "pulse");
